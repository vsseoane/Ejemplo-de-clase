 ...
 */
package com.ejercicio.delivery;
...
public class TopicDeliveryBean implements MessageListener {
    
    public TopicDeliveryBean() {
    }
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            Logger.getLogger(TopicDeliveryBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
